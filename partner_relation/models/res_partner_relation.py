...
class ResPartnerRelation(models.Model):
    ...
    def _get_reverse_relation(self):
        self.ensure_one()
        reverse_rel_type = self.relation_type_id._get_reverse_relation_type_id()
        ...
        assert len(reverse_rels) == 1, "A relation always has one reverse relation"
        return reverse_rels
    ...
    def write(self, vals):
        ...
        for relation in self:
            ...
            assert (
                reverse_rel not in reverse_relations
        ...
        super(ResPartnerRelation, reverse_relations).write(reverse_vals)
